...
public class GroupMember {
    ...
    public static final int NOTYFY_LEVEL_INVALID=-1;//默认不接收消息
    public static final int NOTYFY_LEVEL_NONE=0;//默认通知级别
    public static final int NOTYFY_LEVEL_CLOSE=1;//接收消息提示
    ...
    private int notifyLevel=NOTYFY_LEVEL_NONE;
