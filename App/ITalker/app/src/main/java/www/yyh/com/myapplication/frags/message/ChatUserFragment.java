...
import www.yyh.com.factory.presenter.message.ChatUserPresenter;
...
public class ChatUserFragment extends ChatFragment<User>
    ...
    private MenuItem mUserInfoItem;
    ...
    protected void initToolbar() {
        ...
        mUserInfoItem=toolbar.getMenu().findItem(R.id.action_person);
    }
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
        MenuItem menuItem =mUserInfoItem;
